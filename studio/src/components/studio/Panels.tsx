...
import { I } from '../icons';
import { 
  cn, Badge, IconButton, StepNumber, SectionLabel, FieldShell, AIShimmer, Toggle, Button
} from '../ui';
    ...
    >
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-[13px] text-text leading-snug line-clamp-3" style={{ textWrap: 'pretty' as any }}>{text}</p>
        </div>
      </div>
    </div>
  );
