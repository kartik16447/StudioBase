export const RenderConstants = {
  ...
  CAMERA_SCALE_LIMITS: {
    ...
    near:  1.08,  // subtle nudge
    mid:   1.14,  // comfortable mid-range
    far:   1.20,  // cross-page moves need more context
    max:   1.40,  // Clamped to 1.40 to restrict manual zoom scale limits
    event: 1.15,  // Default cinematic zoom during the focused event phase
  },
};
